  ...
  },
  {
    ...
    description: (
      <>
        ...
        <span className='styleTech styleReact'>REACT</span> and finally styled
            ...
            <div className='schema-primary'>
              <div className='image-primary'>
                <a
                  ...
                  className='image-project image-project1'
                  target='_blank'
                  rel='noopener noreferrer'
              ...
              <div className='carousel-desc-primary'>
                ...
                <p className='carousel-desc-text'>
            ...
            <div className='schema-primary'>
              <div className='image-primary'>
                <a
                  ...
                  className='image-project image-project2'
                  target='_blank'
                  rel='noopener noreferrer'
